...
describe('SubTaskAdd component', () => {
  ...
  it('should render correctly and match the snapshot', () => {
    const subTaskAddComponent = shallow(<SubTaskAdd subTaskListActions={subTaskListActions} />);
  ...
  it('if taskStatus is "Done", then button should be disabled', () => {
    const subTaskAddComponent = shallow(<SubTaskAdd taskStatus="Done" subTaskListActions={subTaskListActions} />);
    const button = subTaskAddComponent.find('.add-subtask-button');
